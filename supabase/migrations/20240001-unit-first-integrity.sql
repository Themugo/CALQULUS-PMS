...
CREATE INDEX IF NOT EXISTS idx_invoices_manager_id  ON invoices(manager_id);
...
ALTER TABLE manager_mpesa_settings
...
LEFT JOIN payment_transactions pt ON pt.unit_id = u.id AND pt.status = 'completed'
