/**
 * @deprecated Alias of initiate-paystack-payment.
 * This is Paystack mobile_money, not Safaricom Daraja.
 * Prefer initiate-paystack-payment (Paystack) or initiate-mpesa-stk-push (Daraja).
 */
...
serve(async (req) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({
      success: true,
      message: "Paystack sent an M-Pesa prompt. Enter your PIN on the phone.",
