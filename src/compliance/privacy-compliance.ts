...
export class PrivacyComplianceManager {
  ...
  private initializeDefaultPolicy(): void {
    const policy: PrivacyPolicy = {
      ...
      content: 'CALQULUS PMS Privacy Policy - We collect and process personal data for property management services...',
      languages: [
        { code: 'en', content: 'CALQULUS PMS Privacy Policy - We collect and process personal data for property management services...' }
      ],
