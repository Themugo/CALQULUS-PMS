...
export const OfflineIndicator: React.FC<OfflineIndicatorProps> = ({
  ...
  return (
    <div
      className={cn(
        'flex items-center gap-2 px-3 py-2 rounded-[8px] text-sm',
        isOffline
...
>(({ isOffline }, ref) => {
  ...
  return (
    ...
    >
      <div className="bg-warning text-warning-foreground px-4 py-2 rounded-[8px] shadow-lg flex items-center gap-2 text-sm font-medium">
        <WifiOff className="h-4 w-4" />
