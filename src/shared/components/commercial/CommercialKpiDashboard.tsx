    ...
    <div className={cn("space-y-4 text-xs", className)}>
      <div className="p-4 rounded-xl border bg-card flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-sm">
        <div>
          <h3 className="text-base font-extrabold text-foreground flex items-center gap-2">
            <TrendingUp className="h-5 w-5 text-emerald-600" /> Executive Commercial KPI & Financial Growth Metrics
          </h3>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <Card className="p-3 border rounded-xl bg-card space-y-1">
          ...
          <strong className="text-lg font-black text-emerald-600">KES 48.6M</strong>
          <span className="text-[9px] text-emerald-600 font-bold block">+3.8M New ARR this Quarter</span>
        </Card>
        ...
        <Card className="p-3 border rounded-xl bg-card space-y-1">
          ...
          <span className="text-[9px] text-emerald-600 font-bold block">94.8% Engagement Rate</span>
        </Card>
        ...
        <Card className="p-3 border rounded-xl bg-card space-y-1">
          ...
          <span className="text-[9px] text-emerald-600 font-bold block">3.1 Months Payback</span>
        </Card>
        ...
        <Card className="p-3 border rounded-xl bg-card space-y-1">
          ...
          <span className="text-[9px] text-emerald-600 font-bold block">98% First Contact Resolution</span>
        </Card>
      </div>
    </div>
  );
