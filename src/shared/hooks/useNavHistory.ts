...
const ROUTE_NAME_MAP: Record<string, { name: string; category: string }> = {
  ...
  "/leases": { name: "Leases", category: "Tenants & Leases" },
  "/tenants": { name: "Tenants", category: "Tenants & Leases" },
  "/tenant-screening": { name: "Tenant Screening", category: "Tenants & Leases" },
  "/invites": { name: "Invites", category: "Tenants & Leases" },
  "/vacation-notices": { name: "Vacation Notices", category: "Tenants & Leases" },
  "/billing": { name: "Billing & Invoices", category: "Financials & Billing" },
  "/water-billing": { name: "Water Billing", category: "Financials & Billing" },
  "/statements": { name: "Statements", category: "Financials & Billing" },
  "/payments": { name: "Payment History", category: "Financials & Billing" },
  "/platform-billing": { name: "Platform Subscriptions", category: "Financials & Billing" },
  "/maintenance": { name: "Maintenance", category: "Operations" },
  "/contracts": { name: "Contracts", category: "Operations" },
  "/landlords": { name: "Landlords", category: "Operations" },
