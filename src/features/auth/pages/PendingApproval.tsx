...
const PendingApproval = () => {
  ...
  }, [isRejected, user?.id, user, navigate]);
  ...
  const isSuspended = isRejected && (managerProfile?.status === 'suspended' || managerProfile?.status === 'suspended_nonpayment');
  const isNonPaymentSuspension = isRejected && managerProfile?.status === 'suspended_nonpayment';
