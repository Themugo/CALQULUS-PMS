...
const TenantLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground hero-gradient px-4">
      <Card className="w-full max-w-md border-primary/20 bg-card/95 backdrop-blur-sm shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          {biometricAvailable && hasStoredCredentials && !biometricLoading && (
            <BiometricLoginButton
              ...
              className="border-primary/20 text-amber-500 dark:text-primary hover:bg-primary/10"
            />
          )}
          ...
          {biometricAvailable && hasStoredCredentials && !biometricLoading && (
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-amber-500 dark:text-primary font-medium">Or continue with email</span>
              </div>
            </div>
          )}
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <ForgotPasswordDialog 
                  variant="tenant"
                  trigger={
                    <button type="button" className="text-amber-500 dark:text-primary hover:text-primary text-sm font-medium">
                      Forgot password?
                    </button>
                  }
                />
        ...
        <CardFooter className="flex flex-col space-y-4 border-t border-border pt-6">
          <div className="text-center w-full space-y-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <Link to="/tenant/signup" className="flex-1">
                <Button variant="outline" className="w-full border-primary/20 text-amber-500 dark:text-primary hover:bg-primary/10 font-medium">
          ...
          <div className="text-center space-y-1">
            <Link to="/landlord" className="text-amber-500 dark:text-primary hover:text-primary text-sm font-medium block">
