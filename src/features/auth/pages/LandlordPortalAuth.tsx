...
const LandlordPortalAuth = () => {
  ...
  useEffect(() => {
    const remembered = localStorage.getItem('calqulus:remembered-email:landlord');
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (rememberMe) localStorage.setItem('calqulus:remembered-email:landlord', email);
    else localStorage.removeItem('calqulus:remembered-email:landlord');
