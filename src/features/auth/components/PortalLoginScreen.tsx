    ...
    <div className="relative min-h-screen w-full overflow-hidden text-white" {...portalSurfaceProps(portalId)}>
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        <header className="flex items-center justify-between gap-4 px-5 py-5 sm:px-8 lg:px-10 xl:px-14">
          <Link to={PUBLIC_ROUTES.home} aria-label="CALQULUS home"><BrandMark size="nav" showWordmark lockup subtitleOverride={brand.descriptor} wordmarkOverride={brand.name} logoUrl={brand.logoUrl} inverse forcePlatform /></Link>
