                                ...
                                {invoice.status === "pending" ? (
                                  <>
                                    ...
                                    <Button
                                      size="sm"
                                      variant="ghost"
                                      onClick={() => handleSendWhatsApp(invoice, 'invoice')}
                                    ...
                                    <Button
                                      size="sm"
                                      variant="outline"
                                      onClick={() => handlePayClick(invoice, "stripe")}
                                    ...
                                    <Button
                                      size="sm"
                                      onClick={() => handlePayClick(invoice, "mpesa")}
                                      disabled={isProcessing}
                                  ...
                                  <span className="text-sm text-muted-foreground">
                                    {invoice.paid_date && `Paid ${format(new Date(invoice.paid_date), "dd/MM")}`}
                                  </span>
                                )}
                              </div>
                            </TableCell>
