...
export async function downloadTenantStatementPDF(
  ...
  doc.text(data.companyName || "CALQULUS RMS Properties", 14, 14);
  ...
  doc.text(
    `This statement was generated by ${data.companyName || "CALQULUS RMS"} on ${today}. For queries, contact ${data.companyEmail || "your property manager"}.`,
