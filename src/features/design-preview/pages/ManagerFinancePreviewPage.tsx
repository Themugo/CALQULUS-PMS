...
import { ManagerFinancePreview } from "@/features/design-preview/components/ManagerFinancePreview";
import { PUBLIC_ROUTES } from "@/features/marketing/publicConfig";
import { portalSurfaceProps } from "@/core/design";

export default function ManagerFinancePreviewPage() {
  useEffect(() => {
    document.title = "CALQULUS PMS | Manager finance preview";
  }, []);

  return (
    <div className="min-h-screen bg-background text-foreground" {...portalSurfaceProps("manager")}>
      <a
        href="#manager-finance-preview"
      ...
      <header className="border-b border-border bg-card">
        <div className="mx-auto flex max-w-[1440px] flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-6">
          <BrandMark size="nav" showWordmark subtitle="Manager finance preview" forcePlatform />
          <p className="type-meta hidden sm:block">Phase 4 — layout chrome, not invented collections</p>
