...
// useAdminPermissions replaced by AuthContext
...
const WebhostManagement = () => {
  ...
  // Bootstrap super admin for first webhost
  useEffect(() => {
    if (!isLoadingMyPermissions && !myPermissions) {
      bootstrapSuperAdmin.mutate();
    }
  }, [isLoadingMyPermissions, myPermissions, bootstrapSuperAdmin]);
