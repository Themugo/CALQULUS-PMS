...
const TierManagement: React.FC = () => {
  ...
  const limitsByTier: Record<string, Record<string, any>> = {};
                ...
                {isExpanded && (
                  <div className="p-3 border-t border-slate-700/30 bg-slate-950/20">
                    ...
                    <div className="space-y-1.5">
                      {cats.map(cat => {
                        const dbCat = categoryData.find((c: any) => c.key === cat.key);
                        ...
                        return (
                          <div key={cat.key} className="flex items-center justify-between p-2 rounded-lg bg-slate-900/40 border border-slate-700/20">
                            <div className="flex items-center gap-2 min-w-0">
                              <div className={`h-6 w-6 rounded flex items-center justify-center bg-${cat.color}-100 shrink-0`}>
