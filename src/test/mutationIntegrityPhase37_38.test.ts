...
describe("Phase 37-38 core portfolio mutation integrity", () => {
  ...
  it("moves active property and unit mutation entry points to RPCs", () => {
    ...
    expect(properties).toContain('supabase.rpc("save_property_atomic"');
    expect(properties).toContain('supabase.rpc("deactivate_property_atomic"');
    expect(detail).toContain('supabase.rpc("assign_tenant_to_unit_atomic"');
    expect(detail).toContain('supabase.rpc("unassign_tenant_from_unit_atomic"');
    expect(units).toContain('supabase.rpc("save_unit_atomic"');
    expect(units).toContain('supabase.rpc("deactivate_unit_atomic"');
