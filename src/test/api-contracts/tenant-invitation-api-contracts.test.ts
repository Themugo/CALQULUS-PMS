...
function generateEmailTemplate(variables: {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      <h1 style="color: #C9A84C;">Welcome to CALQULUS PMS</h1>
      ...
      <a href="${variables.invitation_link}" style="background-color: #C9A84C; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block;">
        Accept Invitation
      </a>
