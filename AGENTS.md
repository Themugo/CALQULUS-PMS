...
- **Tests**: `landingContentEditor.test.ts` (route registration, nav link, provider/Supabase wiring, permission resolution) + `landingConfig.test.ts` extended. Full suite **1219 passed / 1 skipped**; lint 0 errors (11 pre-existing warnings); build clean.
